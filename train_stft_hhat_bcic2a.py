...
def main():
    ...
    train_idx, temp_idx = next(
        splitter1.split(X, y, groups=trial_ids)
    )
    ...
    X_temp = X[temp_idx]
    y_temp = y[temp_idx]
    temp_trials = trial_ids[temp_idx]
    ...
    val_idx, test_idx = next(
        splitter2.split(X_temp, y_temp, groups=temp_trials)
    )
    ...
    torch.save(model.state_dict(), "best_hhat_model.pth")
    print("Best model saved as: best_hhat_model.pth")
